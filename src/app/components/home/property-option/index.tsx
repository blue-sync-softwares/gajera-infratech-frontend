    ...
    return (
        <section className='dark:bg-darkmode'>
            <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto px-4">
                <h2 className="text-4xl font-bold mb-12 text-midnight_text dark:text-white" data-aos="fade-left">Our Completed Projects</h2>
                    ...
                    {propertiesData.map((property, index) => (
                        ...
                        >
                            {/* <Link href={`/properties/properties-list`} className='group'> */}
                                ...
                                <p className="text-base text-gray">{property.count} Projects</p>
                            {/* </Link> */}
                        </div>
                    ))}
                </div>
