...
export default function CompanyInfo() {
    ...
    return (
        <div className='dark:bg-darkmode pt-20 pb-24'>
            ...
            {/* extra spacing to prevent overlap with footer on small screens */}
